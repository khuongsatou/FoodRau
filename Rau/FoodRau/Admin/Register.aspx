<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="FoodRau.Admin.Register" %>
            ...
            <div class="p-5">
                ...
                <div class="user">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4  mb-3 mb-sm-0">
                            <asp:TextBox ID="txtPhone" runat="server" type="number" CssClass="form-control form-control-user" placeholder="Phone" Text="0" ></asp:TextBox>
