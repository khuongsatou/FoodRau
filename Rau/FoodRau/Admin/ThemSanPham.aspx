            ...
            <div class="p-5">
                ...
                <div class="user">
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        <div class="col-sm-4  mb-3 mb-sm-0">
                             <asp:TextBox ID="txtSold" runat="server" TextMode="Number" min="0" placeholder="Sold..." CssClass="form-control form-control-user"></asp:TextBox>
                            <br />
                        </div>
                        <div class="col-sm-4  mb-3 mb-sm-0">
                            <asp:TextBox ID="txtPoint" runat="server" min="0" step="0.01" max="1" placeholder="(%)Point..." CssClass="form-control form-control-user"></asp:TextBox>
                            <br />
                        </div>
                         <div class="col-sm-4  mb-3 mb-sm-0">
                            <asp:TextBox ID="Type" runat="server" placeholder="Type..." CssClass="form-control form-control-user"></asp:TextBox>
                             <br />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4  mb-3 mb-sm-0">
                            <asp:Button ID="btnThem" CssClass="btn btn-primary btn-user btn-block"  runat="server" Text="Thêm" />
                        </div>
