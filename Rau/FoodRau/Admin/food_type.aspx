                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <asp:TextBox ID="txtName" CssClass="form-control form-control-user" runat="server" placeholder="Tên loại"></asp:TextBox>
                                <br />
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <asp:Button ID="btnCapNhat" CssClass="btn btn-primary btn-user btn-block" runat="server" Text="Cập Nhật" ValidationGroup="f_them"  />
                            </div>
                            <div class="col-md-4">
